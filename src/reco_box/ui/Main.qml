                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            AppButton {
                                ...
                                Layout.fillWidth: true
                                onClicked: { if (roomStatus === "recording" || roomStatus === "stalled" || roomStatus === "retrying" || roomStatus === "converting") recordingManager.stop_room(roomId); else { roomModel.toggleRoom(roomId); if (!roomEnabled) monitorCoordinator.checkNow(roomId) } }
                            }
