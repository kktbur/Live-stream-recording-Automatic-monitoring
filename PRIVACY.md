...
and applies it to Reco Box's anonymous TwitCasting requests. PR-07 and PR-08
apply the same policy to first-party Bilibili API and YouTube page/HLS adapters;
the other upstream paths remain pending platform-by-platform verification. Any
future exception must name the platform, exact host, reason, test, and date.
